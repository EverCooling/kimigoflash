...
class FailedDeliveryDetail extends StatefulWidget {

  const FailedDeliveryDetail({Key? key})
    : super(key: key);

  @override
  State<FailedDeliveryDetail> createState() =>
      _FailedDeliveryDetailPageState();
}

class _FailedDeliveryDetailPageState extends State<FailedDeliveryDetail> {
  final AuthApi _authApi = AuthApi();
  final controller = Get.put(FailedDeliveryDetailController());
